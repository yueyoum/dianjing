...
static PyObject* wrap_staff_training_broadcast_reward_gold_per_minute(PyObject* self, PyObject* args)
{
    ...
    if(!PyArg_ParseTuple(args, "iiiiii:staff_training_broadcast_reward_gold_per_minute",
        &staff_level, &zhimingdu, &skill_base, &skill_grow, &skill_level, &building_addition
    ))
        return NULL;
...
// 网店每天收益金币
static PyObject* wrap_staff_training_shop_reward_gold(PyObject* self, PyObject* args)
{
    int shop_income;
    int xintai;
    int yishi;
    ...
    if(!PyArg_ParseTuple(args, "iiiiii:staff_training_shop_reward_gold",
        &shop_income, &xintai, &yishi, &skill_base, &skill_grow, &skill_level
    ))
        return NULL;

    result = staff_training_shop_reward(
        shop_income, xintai, yishi, skill_base, skill_grow, skill_level
    );
...
static PyMethodDef Methods[] = {
    ...
    {"staff_training_shop_reward_gold", wrap_staff_training_shop_reward_gold, METH_VARARGS, ""},
    {NULL, NULL, 0, NULL}
};
