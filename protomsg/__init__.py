...
MESSAGE_TO_ID = {
    ...
    "ClubSetUnitRequest": 423,
    "ClubSetUnitResponse": 424,
    "ClubSetFormationRequest": 425,
    "ClubSetFormationResponse": 426,
    "StaffNotify": 500,
    ...
    "ItemUseRequest": 2204,
    "ItemUseResponse": 2205,
    "ItemMergeRequest": 2206,
    "ItemMergeResponse": 2207,
    ...
    "TrainingMatchGetMatchClubDetailRequest": 2505,
    "TrainingMatchGetMatchClubDetailResponse": 2506,
    "TrainingMatchStoreNotify": 2510,
    "TrainingMatchStoreBuyRequest": 2511,
    "TrainingMatchStoreBuyResponse": 2512,
    "TrainingMatchStoreRefreshRequest": 2513,
    "TrainingMatchStoreRefreshResponse": 2514,
    "EliteNotify": 2600,
    ...
    "EliteChallengeTimesRefreshRequest": 2607,
    "EliteChallengeTimesRefreshResponse": 2608,
...
ID_TO_MESSAGE = {
    ...
    423: "ClubSetUnitRequest",
    424: "ClubSetUnitResponse",
    425: "ClubSetFormationRequest",
    426: "ClubSetFormationResponse",
    500: "StaffNotify",
    ...
    2204: "ItemUseRequest",
    2205: "ItemUseResponse",
    2206: "ItemMergeRequest",
    2207: "ItemMergeResponse",
    ...
    2505: "TrainingMatchGetMatchClubDetailRequest",
    2506: "TrainingMatchGetMatchClubDetailResponse",
    2510: "TrainingMatchStoreNotify",
    2511: "TrainingMatchStoreBuyRequest",
    2512: "TrainingMatchStoreBuyResponse",
    2513: "TrainingMatchStoreRefreshRequest",
    2514: "TrainingMatchStoreRefreshResponse",
    2600: "EliteNotify",
    ...
    2607: "EliteChallengeTimesRefreshRequest",
    2608: "EliteChallengeTimesRefreshResponse",
...
PATH_TO_REQUEST = {
    ...
    "/game/club/setunit/": ["club", "ClubSetUnitRequest"],
    "/game/club/setformation/": ["club", "ClubSetFormationRequest"],
    ...
    "/game/item/use/": ["item", "ItemUseRequest"],
    "/game/item/merge/": ["item", "ItemMergeRequest"],
    ...
    "/game/trainingmatch/detail/": ["training_match", "TrainingMatchGetMatchClubDetailRequest"],
    "/game/trainingmatch/store/buy/": ["training_match", "TrainingMatchStoreBuyRequest"],
    "/game/trainingmatch/store/refresh/": ["training_match", "TrainingMatchStoreRefreshRequest"],
    ...
    "/game/elite/refresh/": ["elite_match", "EliteChallengeTimesRefreshRequest"],
...
PATH_TO_RESPONSE = {
    ...
    "/game/club/setunit/": ["club", "ClubSetUnitResponse"],
    "/game/club/setformation/": ["club", "ClubSetFormationResponse"],
    ...
    "/game/item/use/": ["item", "ItemUseResponse"],
    "/game/item/merge/": ["item", "ItemMergeResponse"],
    ...
    "/game/trainingmatch/detail/": ["training_match", "TrainingMatchGetMatchClubDetailResponse"],
    "/game/trainingmatch/store/buy/": ["training_match", "TrainingMatchStoreBuyResponse"],
    "/game/trainingmatch/store/refresh/": ["training_match", "TrainingMatchStoreRefreshResponse"],
    ...
    "/game/elite/refresh/": ["elite_match", "EliteChallengeTimesRefreshResponse"],
