...
_CHATSENDREQUEST_MSGTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SET_MONEY', index=2, number=2,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TEST_PURCHASE', index=5, number=5,
      options=None,
      type=None),
  ],
  containing_type=None,
