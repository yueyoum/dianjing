...
_STAFF = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='skills', full_name='Dianjing.protocol.Staff.skills', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='training_slots', full_name='Dianjing.protocol.Staff.training_slots', index=14,
