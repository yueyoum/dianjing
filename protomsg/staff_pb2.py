...
_STAFF = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='zhimingdu', full_name='Dianjing.protocol.Staff.zhimingdu', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='training_exp_need_gold', full_name='Dianjing.protocol.Staff.training_exp_need_gold', index=14,
