...
_UNIONEXPLORENOTIFY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='harass_buy_cost', full_name='Dianjing.protocol.UnionExploreNotify.harass_buy_cost', index=7,
...
_UNIONHARASSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='my_explore_point', full_name='Dianjing.protocol.UnionHarassResponse.my_explore_point', index=4,
