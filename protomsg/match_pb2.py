...
_STAFFMATCH_STAFF = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='skills', full_name='Dianjing.protocol.StaffMatch.Staff.skills', index=5,
...
_CLUBMATCH = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='key', full_name='Dianjing.protocol.ClubMatch.key', index=4,
